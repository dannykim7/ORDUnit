				...
				<input type="hidden" name="perPageNum" value="${pageObject.perPageNum }">
					<div class="input-group">
						<select name="key" class="form-control">
							...
							<option value="t/c" ${(pageObject.key =="tc")?"selected":"" }>제목/내용</option>
							<option value="t/w" ${(pageObject.key =="tw")?"selected":"" }>제목/작성자</option>
							<option value="c/w" ${(pageObject.key =="cw")?"selected":"" }>내용/작성자</option>
						</select>
					</div>
					<div class="input-group">
